...
class Reserves extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        if (strpos(curl_getinfo($curl_handle,CURLINFO_RESPONSE_CODE), '200') === false) {
            ...
            $nwCharge->expired_at= $charge['expired_at']==NULL ? date('Y-m-d H:i:s',0) : date('Y-m-d H:i:s',$charge['expired_at']);       
            $nwCharge->captured_at= $charge['captured_at']==NULL ?  date('Y-m-d H:i:s',0)  : date('Y-m-d H:i:s',$charge['captured_at'] );       
